...
- **MIRAGE**
  - [MIRAGE: Succinct Arguments for Randomized Algorithms with Applications to Universal zk-SNARKs](https://eprint.iacr.org/2020/278.pdf)
...
- **Security Risks in Zero Knowledge Proof Cryptocurrencies**
  ...
  - [How to Generate a Groth16 Proof for Forgery](https://medium.com/ppio/how-to-generate-a-groth16-proof-for-forgery-9f857b0dcafd)

### Videoes

- **Star Li : Introduction for zk-SNARKs**
  - [zkSNARK历史](https://www.bilibili.com/video/bv1np4y1H7WJ)
  - [椭圆曲线以及多项式证明](https://www.bilibili.com/video/BV1np4y1H7WJ?p=2)
  - [一般计算的证明](https://www.bilibili.com/video/BV1np4y1H7WJ?p=3)
  - [Groth16](https://www.bilibili.com/video/BV1np4y1H7WJ?p=4)
  - [libsnark源代码解析和实战](https://www.bilibili.com/video/BV1np4y1H7WJ?p=5)
  - [零知识证明场景](https://www.bilibili.com/video/BV1np4y1H7WJ?p=6)
  - [其他](https://www.bilibili.com/video/BV1np4y1H7WJ?p=7)
...
- [ConsenSys](https://github.com/ConsenSys)/**[gnark](https://github.com/ConsenSys/gnark)**
  ...
  - **related repo**
    ...
    - [ConsenSys](https://github.com/ConsenSys)/**[gurvy](https://github.com/ConsenSys/gurvy)**

      Elliptic Curve Cryptography (+Pairing) for BLS381, BLS377 and BN256

    - [ConsenSys](https://github.com/ConsenSys)/**[goff](https://github.com/ConsenSys/goff)**

      A fast field arithmetic library in Go.
